...
#include "../../../Components/widgetinfo.h"
...
QT_MOC_LITERAL(3, 29, 6) // "pFrame"
    ...
    "WidgetInfo\0slot_ChangeFrame\0\0pFrame"
};
...
void WidgetInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->slot_ChangeFrame((*reinterpret_cast< int(*)>(_a[1])));
...
const QMetaObject WidgetInfo::staticMetaObject = {
    { &WidgetBase::staticMetaObject, qt_meta_stringdata_WidgetInfo.data,
